...
- 👨‍👩‍👧 **Conteúdo sob medida por perfil** — **idade**, **foco** (trabalho, viagens, escola, faculdade…) e **temas a evitar** entram em *todas* as chamadas de IA. Um perfil de menor de 18 já bloqueia temas adultos sozinho, mesmo sem ninguém listar nada. *(É instrução para o modelo, não filtro garantido — e não alcança o YouTube.)*
