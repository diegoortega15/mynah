...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { b: 'Clicar na frase (novo):', t: 'na transcrição do YouTube, tocar em qualquer frase pula o vídeo direto para aquele momento — dá para reouvir um trecho difícil quantas vezes quiser sem procurar na barra.' },
      { b: '🌐 mostrar tradução (novo):', t: 'ao marcar, o Mynah traduz o vídeo inteiro de uma vez e guarda no banco. A primeira vez leva alguns minutos (dá para assistir enquanto traduz); depois disso o mesmo vídeo abre já traduzido, na hora e sem gastar IA. A tradução aparece embaixo da fala que está tocando.' },
      ...
      { b: 'Nível do vídeo (novo):', t: 'o Mynah lê a transcrição e estima se o vídeo é A1…C2. Se estiver acima ou abaixo do seu nível, aparece um aviso acima do vídeo — só um aviso: nada fica bloqueado, e um vídeo um degrau acima do seu é justamente onde mais se aprende.' },
      { b: '🔄 atualizar transcrição (novo):', t: 'legendas do YouTube são editadas e as automáticas são regeradas de tempos em tempos. Se a legenda salva ficar velha, o clique na frase pula para o momento errado. Esse botão rebusca a legenda e avisa se mudou — as traduções que continuam valendo são preservadas.' },
      { b: '⭐ Meus canais (novo):', t: 'guarde os canais em que você gosta de procurar vídeo. Cole o endereço do canal (youtube.com/@nome) ou de qualquer vídeo dele — o Mynah descobre o canal sozinho. Clicar num canal abre os vídeos dele; se você digitar um assunto antes, a busca já vai filtrada dentro daquele canal.' },
