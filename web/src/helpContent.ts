...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { b: 'Próximos 14 dias:', t: 'um gráfico da carga que vem pela frente. Cards criados juntos vencem juntos — é comum ver um dia com 9 e vários com zero. Vendo isso antes, dá para adiantar na véspera em vez de ser pego de surpresa.' },
      { b: '📤 Fora da fila:', t: 'nem todo card fica para sempre. Dois saem da rotação: os PROBLEMÁTICOS (errados 8 vezes — errar sempre o mesmo card quer dizer que ele está mal escrito, junta duas ideias ou está acima do seu nível; insistir gasta sua hora no único item que não ensina nada) e os DOMINADOS (passaram de 60 dias de intervalo respondendo com confiança — mais do que resta do plano). Os dois ficam listados, com o motivo, e você pode trazer de volta ou excluir. Um problemático que volta recomeça com o contador de erros zerado.' },
      { b: 'Como ter cards novos:', t: 'três caminhos. Gerar um pack (a IA cria 10 frases sobre um tema no seu nível); “+ card” durante o estudo, nos diálogos, na transcrição do YouTube e na aba Ler — este é o mais valioso, porque salva a frase que VOCÊ travou, com o contexto de onde ela veio; e o baralho “Primeiros passos”, que todo perfil ganha.' },
