...
export const TOPICS: Topic[] = [
  {
    ...
    items: [
      ...
      { b: 'Marcos:', t: 'checkpoints de comportamento nos dias 7, 30, 45, 60 e 90 — contados em dias estudados.' },
  ...
  },
  {
    ...
    items: [
      ...
      { b: 'O dia conta ESTUDO, não calendário:', t: 'o número do dia sobe quando você estuda, não quando a data vira. Se você sumir duas semanas, volta exatamente de onde parou — o plano não te empurra para uma fase que você não construiu. Quando há dias pulados, o app mostra também há quantos dias você começou, para o prazo não sumir de vista.' },
  ...
  },
  {
    ...
    items: [
      ...
      { b: 'Nível do vídeo:', t: 'o Mynah lê a transcrição e estima se o vídeo é A1…C2, e mostra sempre um aviso acima do vídeo — inclusive quando bate com o seu nível. Nada fica bloqueado: um vídeo um degrau acima do seu é justamente onde mais se aprende. Em vídeo novo a avaliação leva alguns segundos e você vê "⏳ Avaliando o nível".' },
  ...
  },
  {
    ...
    items: [
      ...
      { b: 'As 4 notas — o que cada uma quer dizer:', t: '❌ Errei = não lembrei (traz o card de volta rápido). 😓 Custou = acertei, mas com esforço. 🙂 Bom = lembrei sem drama. 😎 Fácil = imediato. Cuidado com a diferença entre Errei e Custou: “Custou” ainda empurra o card para frente, às vezes semanas. Se você não lembrou, o botão é Errei. Passe o mouse em cada botão e o app diz exatamente quando aquele card volta — o mesmo “Custou” pode significar 3 dias num card novo e 11 num card antigo.' },
      { b: 'Dias sem card são normais:', t: 'o agendador (FSRS) traz cada card só no dia certo, e o intervalo mínimo é de 1 a 2 dias. Depois de uma sessão grande, é comum o dia seguinte não ter nada. A tela avisa quantos cards voltam e quando, e o bloco 🗂️ Vocabulário conta como feito nesses dias — você não perde o streak por causa de um dia que o agendador deixou vazio.' },
      { b: '⏩ Adiantar próximos:', t: 'quando não há nada vencendo, esse botão traz os cards que vencem em seguida. Serve para manter o hábito num dia vazio. O preço: revisar antes da hora dá menos informação ao agendador, então ele calcula os próximos intervalos com menos precisão. Use quando quiser estudar, não todo dia.' },
  ...
  },
  {
    ...
    items: [
      ...
      { b: 'Primeira execução:', t: 'ao criar um perfil o app passa por quatro passos, nessa ordem: seus dados, a IA que vai gerar o conteúdo, a voz que vai narrar, e o teste de nível. A ordem importa — o teste narra inglês com a voz do navegador, e tudo depois dele depende da IA. Se a IA e a voz já estiverem configuradas na máquina, esses passos aparecem com ✅ e você só clica em Continuar.' },
      { b: '🎯 Descobrir meu nível:', t: 'um teste adaptativo de ~8 minutos, em três partes: quais palavras você conhece (com palavras inventadas plantadas — marcar uma mostra que você está chutando e o bloco deixa de valer), 5 trechos falados para entender, e 8 frases para completar. As perguntas ficam mais difíceis conforme você acerta. O resultado nunca troca seu nível sozinho: ele mostra o que achou, quanto você acertou em cada parte, e você decide. Também aparece logo depois de criar um perfil, e o histórico dos testes fica guardado — refazer no dia 45 mostra a evolução. Num navegador sem voz em inglês instalada, a parte de ouvir é pulada e o resultado diz isso — melhor não avaliar do que inventar uma nota.' },
      ...
      { b: 'Sobre o conteúdo gerado (idade, foco, temas a evitar):', t: 'três campos que entram em TODAS as chamadas de IA — diálogos, textos, cards, tutor, roleplay e correções. O **foco** diz sobre o que o conteúdo deve ser (padrão: trabalho, carreira e tecnologia; troque por viagens, escola, faculdade, o que fizer sentido). Os **temas a evitar** a IA nunca escreve. E a **idade**, se for menor de 18, já bloqueia sozinha temas adultos (violência, romance, bebida, drogas, jogo) mesmo que você não liste nada — porque o que um pai esquecer de listar é justamente o que passaria.' },
      { b: 'Limite importante:', t: 'isso é uma instrução para a IA, não um filtro garantido: reduz muito a chance de aparecer o que você bloqueou, mas não elimina. E não alcança o YouTube — lá o vídeo é escolhido por quem está usando, e o Mynah só lê a legenda. Se o perfil é de criança, vale acompanhar a escolha dos vídeos.' },
      { b: 'Tema recusado:', t: 'se você pedir um tema que conflita com o perfil, o app avisa que o tema não combina — em vez de dizer que a IA falhou. É a trava funcionando, não um erro.' },
